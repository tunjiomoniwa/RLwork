 ...
 \textit{Objective} & \textit{Work} & \textit{SA-based} & \textit{MA-based} & \textit{SP-based} & \textit{MP-based} & \textit{Collaborative} & \textit{Non-collaborative} \\
  \hline \hline
   Maximize data throughput &~\cite{Zhong2018} & \checkmark & - & - & \checkmark & - & \checkmark\\
                            &~\cite{Jadoon2017} & - & \checkmark & \checkmark & - & \checkmark & - \\ \hline
   Optimize server activation policy &~\cite{Conti2017} &  \checkmark & - & \checkmark & - & - & \checkmark\\ \hline
   Minimize computational latency&~\cite{Mai2018} & - & \checkmark & \checkmark & - & \checkmark & - \\ \hline
   Optimize traffic  &~\cite{routray2017} & - & \checkmark & \checkmark & - & \checkmark & -\\
                     &~\cite{Liu2017} & - & \checkmark & \checkmark & - & \checkmark & -\\ \hline
   Minimize communication cost &~\cite{OmoniwaRelay2018}  & \checkmark & - & - & \checkmark & \checkmark & -\\
                                &~\cite{Li2015}  & \checkmark & - & - & \checkmark & - & \checkmark \\
                                &~\cite{Camelo2016} & - & \checkmark & \checkmark & - & - & \checkmark\\ \hline
   Optimize scheduling strategy &~\cite{Wen15} & \checkmark & - & \checkmark & - & - & \checkmark\\
                                &~\cite{Zhu2013} & \checkmark & - & \checkmark & - & - & \checkmark \\ \hline
   Optimize power allocation &~\cite{Khan2018} & - & \checkmark & \checkmark & - & \checkmark & -\\ \hline
   Optimize resource allocation &~\cite{Gai2018} & \checkmark & - & \checkmark & - & - & \checkmark\\
                                &~\cite{Mohammadi2018} & \checkmark & - & \checkmark & - & - & \checkmark\\
