...
\indent
    \begin{enumerate}[leftmargin=*,label= \arabic*)]
      \item Efficient energy utilization within the network: Just like the traditional IoT architecture, the fog-based IoT networks are often power-constrained. Furthermore, IoT devices deplete energy in several ways, such as when transmitting and receiving data, listening to the medium, performing computation or even changing position.
      
      \item Channel assessment and intelligent routing:
      ...
      \item Federation and support for ubiquity of IoT devices:
      
      \item Resource-compatibility and adaptability in unknown/dynamic environment.
