...
\title{Reinforcement Learning for Fog-based Internet-of-Things: Applications and Research Issues}
%
%
...
With the inherent heterogeneity in the IoT ecosystem and devices operating in a highly dynamic environment, it becomes necessary to leverage robust and resource-fitting machine learning techniques that will match the resource-constrained nature and stochastic behaviour of the IoT network. 
