...
\emph{\textbf{Goal}}: The goal is for the agent to learn to minimize cost, $\langle$Outage communication cost ($\mathcal{P}_{out}$) /Energy of the fog relay (J) /Energy of the IoT sensor (J)$\rangle$.
