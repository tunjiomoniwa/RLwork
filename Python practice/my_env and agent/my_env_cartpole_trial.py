...
for epi in range(episodes):
    ...
    obs = np.array([random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05)])

##    if epi<300:
##        obs = np.array([random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05), random.uniform(-0.05, 0.05)])
##    else:
##        obs = np.array([random.uniform(-0.01, 0.01), random.uniform(-0.01, 0.01), random.uniform(-0.01, 0.01), random.uniform(-0.01, 0.01)])
    ...
    iter=0
    while ((iter < iteration_steps) and current_state!=(0, 0, 0, 0)):
        ...
        if epi<200:
            # update q values
            update_q(current_state, new_state, action, reward, alpha, gamma)
